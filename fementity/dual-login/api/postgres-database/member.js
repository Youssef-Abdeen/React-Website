...
app.post('/add-member', (req, res) => {
    const { firstName, lastName, pronouns, occupation, emailAddress, phoneNumber, address, city, province, workshops, podcast, courseReferral, socialMedia, giveaway} = req.body;
    db('Member')
        .insert({
...
/*
// DELETE: Delete movie by memberID from the database
...
// PUT: Update movie by memberID from the database
