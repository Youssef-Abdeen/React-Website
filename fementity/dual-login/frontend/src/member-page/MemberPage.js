    ...
    >
        ...
        />
            ...
            <Heading>FirstName LastName</Heading>
                <Text height={"20px"} color={"primay"}>Pronouns</Text>
            </HStack>
            
            <HStack paddingLeft={"160px"}>
            <Text fontSize={"20px"}>Occupation</Text>
            <Text fontSize={"20px"}>|</Text>
            <Text fontSize={"20px"} color={"primay"}>Astrology Sign</Text>
            </HStack>
            
            <HStack>
                <Divider marginTop={"60px"} borderColor={"primay"} border={"1px"} orientation='horizontal'/>
            </HStack>

            <HStack>
                <Box width={"60%"} padding={"25px"}>
                    <Box borderRadius={"4px"} backgroundColor={"#d8b1b2"} padding={"10px"} boxShadow="dark-lg"rounded="md" border={"1px"}>
                        <Text fontSize={"20px"}>Course In-Progress</Text>
                    </Box>
                    <Box borderRadius={"4px"} backgroundColor={"background"} padding={"20px"} boxShadow="dark-lg"rounded="md" border={"1px"}>
