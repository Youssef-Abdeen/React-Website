...
export default function MemberForm() {
  ...
  //Form submit functions developed by winter 2022 team
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        <VStack spacing={4} align="flex-start" w="full">
          ...
          {error && (
            <Alert ref={errorRef} rounded={5} status="error">
              <AlertIcon /> {error}
            </Alert>
          )}

          {/* Required information for member signup */}
          ...
          {/* Optional information for member signup */}
          <VStack spacing={1} align={['flex-start', 'left']} w="full">
          ...
          {/* Payment information for member signup, also required */}
          <VStack spacing={1} align={['flex-start', 'left']} w="full">
            <Heading mt={8}>Payment Information</Heading>
          </VStack>
